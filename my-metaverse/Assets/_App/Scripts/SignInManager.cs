...
{ 
    ...
    { 
        ...
        usernameInput.text = "testuser@cloudcontraptions.com";
    ...
    { 
        ...
        auth.SignInWithEmailAndPasswordAsync(usernameInput.text, passwordInput.text).ContinueWithOnMainThread(async task => 
        { 
            if (task.IsCanceled) 
            { 
            ...
            FirebaseUser existingUser = task.Result.User; 
